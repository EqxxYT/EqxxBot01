...
const textImg = (teks) => {
   ...
   //FAKEREPLY PRODUCT
            const ftoko = {
                  key: {fromMe: false,participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "60139571124@s.whatsapp.net" } : {})},message: {"productMessage": {"product": {"productImage":{"mimetype": "image/jpeg","jpegThumbnail": fs.readFileSync(`./stik/thumb.jpeg`)},"title": `ZAKI GANTENG KAN? \n${pushname}`,"description": "𝙺𝙸𝚉𝙰𝙺𝙸𝚇𝙳", "currencyCode": "IDR","priceAmount1000": "9999999999","retailerId": "ɪ ᴀᴍ ᴢᴀᴋʙᴏᴛᴢ","productImageCount": 1},"businessOwnerJid": `0@s.whatsapp.net`}}}
            //FAKE KONTAK
            const fkontak = { 
...
const fakevn = {
	 ...
	 { remoteJid: "6285878313791-60139571124@g.us" } : {}) 
                },
	 message: { 
		"audioMessage": {
            ...
            //FAKEREPLY VIDEO
            const fvideo = {
                  key: {fromMe: false,participant: `6285878313791@s.whatsapp.net`, ...(from ? { remoteJid: "6289643739077-1613049930@g.us" } : {}) },message: { "videoMessage": { "title":"Apasih Lu","h": `Hmm`,'seconds': '-99999', 'caption': `${fake}`,'jpegThumbnail': fs.readFileSync('./stik/thumb.jpeg')}}}
const fvid = {
	 key: { 
	 ...
	 message: { 
            ...
            const fgc = {
                  key: {"fromMe": false,"participant": "0@s.whatsapp.net","remoteJid": "0@s.whatsapp.net"},"message": {"groupInviteMessage": {"groupJid": "6285878313791-1616169743@g.us","inviteCode": "mememteeeekkeke","groupName": "P", "caption": `${fake}`, 'jpegThumbnail': fs.readFileSync('./stik/thumb.jpeg')}}}
            //FAKEREPLY GIF
            const fgif = {
                  key: {fromMe: false,participant: `6285878313791@s.whatsapp.net`, ...(from ? { remoteJid: "6289643739077-1613049930@g.us" } : {}) },message: { "videoMessage": { "title":"Apasih Lu","h": `Hmm`,'seconds': '99999', 'gifPlayback': 'true', 'caption': `${fake}`,'jpegThumbnail': fs.readFileSync('./stik/thumb.jpeg')}}} 
...
*Model* : ${i.phone.device_model}\n\n`
	...
	case 'start':
        ...
        txtt =`Hai Kak ${pushname}\nPilih Opsi Dibawah Ini Ya.. `
               ...
               {buttonId:`${prefix}owner`,buttonText:{displayText:'👤 ORANG GANTENG'},type:1},
               {buttonId:`${prefix}ytadmin`,buttonText:{displayText:'⎙ NEKOPOI'},type:1},
               {buttonId: `${prefix}shutdown`,buttonText:{displayText: '☰ SHUTDOWN BOT'},type:1}]
               ...
               buttonsMessage = {
               contentText: `${txtt}`,
               footerText: '© Creator 𝙺𝙸𝚉𝙰𝙺𝙸𝚇𝙳\nSupport Me Or Subscribe', imageMessage: imageMsg,
               buttons: buttons,
               headerType: 4
}
